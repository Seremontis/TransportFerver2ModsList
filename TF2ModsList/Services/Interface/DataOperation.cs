    ...
    public class DataOperation : IDataOperation
    {
        ...
        private DetailMod ExtractDetailMod()
        {
            DetailMod detailMod = new DetailMod()
            {
                ...
                SpecificationMod = _selectedNode.SelectSingleNode("div[@class='section']/ul/li/article/div/div/div[@class='section']").InnerHtml,
            ...
            detailMod.ListPictures = GetListPictures(_selectedNode.SelectSingleNode("div[@class='section']/ul/li/article/div/footer/section/ul"));
            return detailMod;
        }
        ...
        private List<string> GetAuthors(HtmlNode node)
        {
            ...
            foreach (var item in node.ChildNodes)
            {
                if (item.Name == "tr")
                {
                    var value = item.SelectSingleNode("td/a").InnerText;
                    vs.Add(value);
                }
        ...
        private List<Uri> GetListPictures(HtmlNode node)
        {
